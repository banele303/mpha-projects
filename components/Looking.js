...
const Looking = () => {
  return (
    <div>
      <div className="looking  pt-[4rem] bg-blue-400 md:mb-[5rem] mx-[3rem] rounded-md pb-[3rem]  ">
        <div className="flex flex-col py-[2rem]  justify-center  w-full items-center">
          <h1 className="text-Poppins text-white opacity-80 text-xl md:text-3xl font-bold font-Poppins pl-3 pt-2">
            Looking for Renovations Quote in SOUTH AFRICA ?
          </h1>
          <p className="text-[15px] flex w-[700px] text-white opacity-80 font-Poppins text-center font-bold  pt-5">
          ...
          <button className="md:mt-[3rem] text-white opacity-80 outline py-2 flex font-Poppins hover:text-blue-900 justify-center  rounded-[6px] items-center px-5 text-2xl sm:text-1xl font-semibold mt-5 ">
            Get QUOTE
          </button>
        </div>
      </div>
      <div className="flex flex-col  items-center pt-][4rem]">
        ...
        <p className="text-[15px] flex w-[700px] font-Poppins text-center font-bold  pt-5">
